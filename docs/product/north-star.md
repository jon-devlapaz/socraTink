...
Socratink gives every learner a persistent Learner Agent that grows with them across subjects, goals, models, skills, and personas.

The Learner Agent understands what the learner is trying to become capable of, maintains an evidence-grounded account of what they have actually demonstrated, and chooses the next learning experience that can help them grow without doing the learning for them.
...
> Your agent grows with you, remembers what you have actually demonstrated, and finds a better way to help you learn anything without doing the learning for you.

The Learner Agent does not merely answer questions correctly. It knows enough about where the learner is, where they are trying to go, and what has helped before to choose challenges, explanations, examples, personas, and moments of assistance that help the learner keep becoming more capable.

## Motivation is a primary product responsibility

Correct pedagogy is not sufficient when the learner has lost the desire or belief required to continue. Motivation, curiosity, and the feeling that another intelligence is invested in the learner's growth are part of the product's job.
...
- recognize discouragement, overload, uncertainty, and loss of purpose as reasons to adapt the learning experience rather than simply repeat an explanation;
...
This north star keeps three kinds of claims distinct.

**Founder commitments** include the value of human learning, the learner's capacity to grow, learner ownership, epistemic honesty, motivation without manipulation, and the refusal to confuse agent output with learner capability.
